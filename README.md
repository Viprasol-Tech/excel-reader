...
Read Excel files with sheet detection
...
```bash
git clone https://github.com/Viprasol-Tech/excel-reader
cd excel-reader
pip install -e .
```
...
result = ExcelReader.process("data")
print(result)
```
...
```bash
python -m excel_reader "your input here"
```
